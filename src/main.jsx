...
function App() {
  ...
  async function checkForAppUpdate() {
    ...
    try {
      ...
      setUpdateStatus(result.available ? `Version ${result.version} will install when Forge AI closes` : `Up to date (${result.currentVersion})`)
    } catch (error) {
      setUpdateInfo(null)
